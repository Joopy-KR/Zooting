...
public class MeetingService {
    ...
    private WaitingRoom createWaitingRoom(MeetingMemberDto meetingMemberDto) {
        ...
        WaitingRoom waitingRoom = WaitingRoom.builder().roomId(randomUUID).meetingMembers(Set.of(meetingMemberDto))
                .acceptCount(0).build();
    ...
    private void waitingRoomRegistryMessagePublisher(WaitingRoom waitingRoom) {
        redisPublisher.publish(MessageType.REDIS_HASH.getPrefix() + waitingRoom.getRoomId(),
