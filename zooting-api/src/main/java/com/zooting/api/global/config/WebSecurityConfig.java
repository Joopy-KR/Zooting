...
public class WebSecurityConfig {
    ...
    private static final String[] URL_WHITE_LIST = {"/", "/error", "/login", "/favicon.ico", "/health", "/api-docs/**",
            "/swagger-ui/**", "/swagger-resources/**", "/swagger-ui.html", "/api/token/**"};
...
//                 JWT 토큰을 쿠키에 넣을지, LocalStorage에 넣을지에 따라 비활성화 여부 결정
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        final List<String> allowedOriginPatterns = List.of("http://localhost:8080", "http://localhost:5173",
