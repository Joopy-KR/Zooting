...
import type {UserInfo} from "@/types/global.js";

const props = defineProps({
  userInfo: Object as () => UserInfo,
  isOpenPersonalityDialog: Boolean | undefined,
});
...
const setIsOpenPersonalityDialog = (status: boolean) => {
  emits("setIsOpenPersonalityDialog", false);
}
...
<template>
  <TransitionRoot as="template" :show="isOpenPersonalityDialog">
    <Dialog as="div" class="relative z-10" @close="setIsOpenPersonalityDialog(false)">
