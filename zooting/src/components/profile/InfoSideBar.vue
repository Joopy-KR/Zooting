...
<template>
  <div class="relative">
    ...
    />
    <div @click="moveToSetting" class="absolute right-2 top-2">
      <svg
          v-if="isMyProfile"
          ...
          stroke-width="1.5"
          stroke="currentColor"
          class="w-8 h-8 cursor-pointer hover:fill-slate-400"
      >
        <path
    ...
    <div class="flex flex-col h-screen gap-2 px-4 pt-10">
      <div class="w-full">
        ...
        <div class="flex justify-center">
          <div class="relative flex justify-center w-2/5">
            <img :src="userInfo?.maskImgUrl" class="p-2 bg-gray-100 rounded-full min-w-48" :alt="userInfo?.maskImgUrl"/>
            <div v-if="isMyProfile" class="absolute -right-3 bottom-1" @click="moveToMaskList">
              <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
      ...
      <div class="mx-8 my-4">
        <div class="flex items-center justify-center p-2">
          <div
              class="relative text-xl font-bold underline lg:text-3xl text-stone-800 decoration-pink-300 decoration-wavy"
          >
            {{ userInfo?.nickname }}
            <div class="absolute bottom-1 -right-7">
        ...
        <div class="flex flex-row justify-center gap-10 py-3">
        ...
        <div class="flex justify-center px-4 py-2 text-xl font-bold tracking-tight cursor-pointer lg:text-2xl text-rose-500 hover:text-rose-600"
      ...
      <div class="interest__container">
        <div class="flex items-end justify-center h-full">
          <div class="relative w-full mx-5 shadow-inner rounded-3xl shadow-pink-200">
