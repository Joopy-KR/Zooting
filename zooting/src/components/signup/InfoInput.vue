...
.interest__item {
  @apply bg-white hover:bg-gray-50 border border-gray-300 rounded-md text-center flex justify-center items-center;
  height: 50px;
}
